...
export default function EventsGuide() {
  return <main className="min-h-screen bg-[#08050d] text-white"><PageHero eyebrow="Guide" title="Events Guide" text="Learn how Zelmyra's server-wide events work and how to compete for rewards." image="/images/players-event.png" /><section className="mx-auto max-w-7xl px-6 py-24"><InfoGrid items={items} /></section><GuideNav current="/guides/events" />
      <CTA /></main>;
}
