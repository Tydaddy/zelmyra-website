...
export default function GettingStartedGuide() {
  return <main className="min-h-screen bg-[#08050d] text-white"><PageHero eyebrow="Guide" title="Getting Started" text="Your first steps on Zelmyra: join, claim land, rank up, vote, explore, and begin building toward long-term progression." image="/images/hero-spawn.png" /><section className="mx-auto max-w-7xl px-6 py-24"><InfoGrid items={items} /></section><GuideNav current="/guides/getting-started" />
      <CTA /></main>;
}
