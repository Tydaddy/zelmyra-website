...
export default function VotingGuide() {
  return <main className="min-h-screen bg-[#08050d] text-white"><PageHero eyebrow="Guide" title="Voting Guide" text="Vote daily, earn rewards, trigger vote parties, and help more players discover Zelmyra." image="/images/event-fishing-frenzy.png" /><section className="mx-auto max-w-7xl px-6 py-24"><InfoGrid items={items} /></section><GuideNav current="/guides/voting" />
      <CTA /></main>;
}
